...
data = pickle.load( open( "C:/Users/Mohan/Documents/thor/thor-data.pkl", "rb" ) )
words = data['words']
classes = data['classes']
with open('C:/Users/Mohan/Documents/thor/thor.json') as json_data:
...
with open(f'C:/Users/Mohan/Documents/thor/thor-model.pkl', 'rb') as f:
    model = pickle.load(f)
...
def chat(sentence, intents):
    ...
    return_resp = []
    if not results:
        return  "Sorry, can't understand you <br>For further details, please email us at info@thorsignia.in or call at +91-9008097780. <br>We would be glad to assist you."
    for r in results:
        return_list.append((classes[r[0]], str(r[1])))
